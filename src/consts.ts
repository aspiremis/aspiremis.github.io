...
export const NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Laboratory Academy', href: '/lab', hint: 'Hardware, benches, experiments' },
...
export const ALL_PAGES = [
  ...
  { label: 'Laboratory Academy', href: '/lab', section: 'Pages' },
  { label: 'Lab instruments', href: '/lab/instruments', section: 'Pages' },
